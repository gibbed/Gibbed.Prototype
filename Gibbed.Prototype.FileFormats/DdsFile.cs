	...
	public class DdsFile
	{
		...
		public void Load(System.IO.Stream input)
		{
			...
			if ( ( m_header.m_pixelFormat.m_flags & ( int )DdsPixelFormat.PixelFormatFlags.FourCC ) != 0 )
			{
				...
				{
					case	0x31545844:
						squishFlags = ( int )DdsSquish.SquishFlags.DXT1;
						break;

					case	0x33545844:
						squishFlags = ( int )DdsSquish.SquishFlags.DXT3;
						break;

					case	0x35545844:
						squishFlags = ( int )DdsSquish.SquishFlags.DXT5;
						break;
				...
				int blockSize = ( ( squishFlags & ( int )DdsSquish.SquishFlags.DXT1 ) != 0 ) ? 8 : 16;
